package com.example.lksynthesizeapp.ChiFen.service;
...
public class WhiteService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // 设置点击通知跳转的Intent
        Intent nfIntent = new Intent(this, DescernActivity.class);
        // 设置 延迟Intent
