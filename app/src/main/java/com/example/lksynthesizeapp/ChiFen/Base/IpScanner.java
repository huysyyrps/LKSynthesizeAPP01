...
public class IpScanner {
    ...
    public void startScan() {
        ...
        if (hostIP==null){
            Toast.makeText(MyApplication.getContext(), "请开启热点", Toast.LENGTH_SHORT).show();
            return;
        }
            ...
            public void run() {
                try {
                    ...
                    while ((line = reader.readLine()) != null) {
                        Log.e("kalshen1111", "run: " + line);
                        if (!line.contains("00:00:00:00:00:00")&&!line.contains("IP")) {
                            String[] split = line.split("\\s+");
                            if (split[3].equals("lladdr")){
                                if (split[0].startsWith("192.168.43.")){
